...
/******/ 	deferredModules.push(["./client/scripts/entrypoints/pageOrderList.js","vendor"]);
...
/***/ "./client/scripts/adapter/processAdapter/services/setOrder.js":
/*!********************************************************************!*\
  !*** ./client/scripts/adapter/processAdapter/services/setOrder.js ***!
  \********************************************************************/
/*! no static exports found */
...
var _orderList = __webpack_require__(/*! ./client/scripts/port/redux/packages/orderList */ "./client/scripts/port/redux/packages/orderList.js");
...
function* fetchOrder() {
  ...
  const {
    payload,
    error
  } = yield (0, _effects.call)(_API_FUNC.default.GET.ORDER, {
    customer_id
  });
  if (!payload && error) throw new Error('not found Order');
  yield (0, _effects.all)([(0, _lodash.map)(payload['data']['order_list'], orderList => {
    return (0, _effects.put)(_orderList.creators.pushOrder({
      orderList: (0, _humps.camelizeKeys)(orderList)
    }));
  })]);
  yield (0, _effects.put)(_common.creators.deleteFetchingQueue({
    eventkey: 'setOrder'
...
function* subscribeToSetInitialOrderList() {
  while (true) {
    yield (0, _effects.take)(_orderList.types.setInitialOrderList);
    const customerVM = yield (0, _effects.select)(state => state.customerVM);
    const exist = customerVM.exist();
    if (!exist) continue;
    yield (0, _effects.fork)(fetchOrder);
    break;
  }
}

const _default = function* () {
  yield (0, _effects.fork)(subscribeToSetInitialOrderList);
};
...
(function () {
  ...
  reactHotLoader.register(fetchOrder, "fetchOrder", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/adapter/processAdapter/services/setOrder.js");
  reactHotLoader.register(subscribeToSetInitialOrderList, "subscribeToSetInitialOrderList", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/adapter/processAdapter/services/setOrder.js");
  reactHotLoader.register(_default, "default", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/adapter/processAdapter/services/setOrder.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/domain/OrderList/Order.js":
/*!**************************************************!*\
  !*** ./client/scripts/domain/OrderList/Order.js ***!
  \**************************************************/
/*! no static exports found */
...
const OrderModel = def => class extends (0, _Entity.default)(props(def)) {
  /**********************
   * Getter
   **********************/
  getItems() {
...
(function () {
  ...
  reactHotLoader.register(props, "props", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/domain/OrderList/Order.js");
  reactHotLoader.register(OrderModel, "OrderModel", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/domain/OrderList/Order.js");
  reactHotLoader.register(_default, "default", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/domain/OrderList/Order.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/domain/OrderList/OrderList.js":
/*!******************************************************!*\
  !*** ./client/scripts/domain/OrderList/OrderList.js ***!
  \******************************************************/
/*! no static exports found */
...
var _OrderView = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/domain/OrderList/OrderView */ "./client/scripts/domain/OrderList/OrderView.js"));
...
const OrderListModel = def => class extends (0, _Entity.default)(props(def)) {
  /**********************
   * Getter
   **********************/
  getOrderList() {
  ...
  pushOrder({
    ...
    return this.update('list', list => list.push(new _OrderView.default().restoreCreatedAt(createdAt).setItems(items)));
  }
...
(function () {
  ...
  reactHotLoader.register(props, "props", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/domain/OrderList/OrderList.js");
  reactHotLoader.register(OrderListModel, "OrderListModel", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/domain/OrderList/OrderList.js");
  reactHotLoader.register(_default, "default", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/domain/OrderList/OrderList.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/domain/OrderList/OrderListView.js":
/*!**********************************************************!*\
  !*** ./client/scripts/domain/OrderList/OrderListView.js ***!
  \**********************************************************/
/*! no static exports found */
...
var _OrderList = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/domain/OrderList/OrderList */ "./client/scripts/domain/OrderList/OrderList.js"));
...
class OrderListViewModel extends (0, _OrderList.default)({}) {
  constructor(args) {
    super(args);
  }
...
exports.default = OrderListViewModel;
;
...
(function () {
  ...
  reactHotLoader.register(OrderListViewModel, "OrderListViewModel", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/domain/OrderList/OrderListView.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/domain/OrderList/OrderView.js":
/*!******************************************************!*\
  !*** ./client/scripts/domain/OrderList/OrderView.js ***!
  \******************************************************/
/*! no static exports found */
...
var _Order = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/domain/OrderList/Order */ "./client/scripts/domain/OrderList/Order.js"));
...
class OrderViewModel extends (0, _Order.default)({}) {
  constructor(args) {
    super(args);
  }
...
exports.default = OrderViewModel;
;
...
(function () {
  ...
  reactHotLoader.register(OrderViewModel, "OrderViewModel", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/domain/OrderList/OrderView.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/entrypoints/pageOrderList.js":
/*!*****************************************************!*\
  !*** ./client/scripts/entrypoints/pageOrderList.js ***!
  \*****************************************************/
/*! no static exports found */
...
var _orderList = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/presentation/views/modules/orderList */ "./client/scripts/presentation/views/modules/orderList/index.js"));
...
var _orderList2 = __webpack_require__(/*! ./client/scripts/port/redux/packages/orderList */ "./client/scripts/port/redux/packages/orderList.js");
...
var _OrderListView = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/domain/OrderList/OrderListView */ "./client/scripts/domain/OrderList/OrderListView.js"));
...
var _setOrder = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/adapter/processAdapter/services/setOrder */ "./client/scripts/adapter/processAdapter/services/setOrder.js"));
...
const rootReducer = (0, _extendReducers.default)({
  ...
  orderListVM: (0, _orderList2.reducer)(new _OrderListView.default())
});
...
const MainViewAdaptedStore = () => {
  return _react.default.createElement(_viewAdapter.default, {
    store: store
  }, _react.default.createElement(_orderList.default, null));
};

(0, _renderViews.default)('data-react-header-app', HeaderViewAdaptedStore);
(0, _renderViews.default)('data-react-orderlist-app', MainViewAdaptedStore);
(0, _runRootSaga.default)(_processAdapter.sagaMiddleware)([_commonService.default, _auth.default, _setProducts.default, _setOrder.default]);
;
...
(function () {
  ...
  reactHotLoader.register(rootReducer, "rootReducer", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/entrypoints/pageOrderList.js");
  reactHotLoader.register(store, "store", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/entrypoints/pageOrderList.js");
  reactHotLoader.register(HeaderViewAdaptedStore, "HeaderViewAdaptedStore", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/entrypoints/pageOrderList.js");
  reactHotLoader.register(MainViewAdaptedStore, "MainViewAdaptedStore", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/entrypoints/pageOrderList.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/port/redux/packages/orderList.js":
/*!*********************************************************!*\
  !*** ./client/scripts/port/redux/packages/orderList.js ***!
  \*********************************************************/
/*! no static exports found */
...
const {
  ...
  creators,
  reducer
} = (0, _createActionReducer.default)(['pushOrder', 'setInitialOrderList'], '/orderList/');
exports.reducer = reducer;
exports.creators = creators;
exports.types = types;
;
...
(function () {
  ...
  reactHotLoader.register(types, "types", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/port/redux/packages/orderList.js");
  reactHotLoader.register(creators, "creators", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/port/redux/packages/orderList.js");
  reactHotLoader.register(reducer, "reducer", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/port/redux/packages/orderList.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/presentation/views/modules/orderList/hocs/connector.js":
/*!*******************************************************************************!*\
  !*** ./client/scripts/presentation/views/modules/orderList/hocs/connector.js ***!
  \*******************************************************************************/
/*! no static exports found */
...
const creators = _extends({}, _orderList.creators);
...
(function () {
  ...
  reactHotLoader.register(creators, "creators", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/orderList/hocs/connector.js");
  reactHotLoader.register(connector, "connector", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/orderList/hocs/connector.js");
  reactHotLoader.register(_default, "default", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/orderList/hocs/connector.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/presentation/views/modules/orderList/index.js":
/*!**********************************************************************!*\
  !*** ./client/scripts/presentation/views/modules/orderList/index.js ***!
  \**********************************************************************/
/*! no static exports found */
...
var _OrderList = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/presentation/views/modules/orderList/organisms/OrderList */ "./client/scripts/presentation/views/modules/orderList/organisms/OrderList.js"));
...
function App() {
  return _react.default.createElement(_react.Fragment, null, _react.default.createElement(_OrderList.default, null));
}
...
(function () {
  ...
  reactHotLoader.register(App, "App", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/orderList/index.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/presentation/views/modules/orderList/molecules/Order.js":
/*!********************************************************************************!*\
  !*** ./client/scripts/presentation/views/modules/orderList/molecules/Order.js ***!
  \********************************************************************************/
/*! no static exports found */
...
var _OrderItem = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/presentation/views/modules/orderList/molecules/OrderItem */ "./client/scripts/presentation/views/modules/orderList/molecules/OrderItem.js"));

var _TotalAmount = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/presentation/views/modules/orderList/molecules/TotalAmount */ "./client/scripts/presentation/views/modules/orderList/molecules/TotalAmount.js"));
...
function Order({
  ...
  const items = orderVM.getItems().map(({
    productCode,
    quantity
  }, idx) => {
    return _react.default.createElement(_OrderItem.default, _extends({
      key: idx
    }, {
      productsVM,
      productCode,
  ...
  return _react.default.createElement("div", {
    className: "ordrlst-Order"
  }, _react.default.createElement("div", {
    className: "ordrlst-Section"
  }, _react.default.createElement("div", {
    className: "ordrlst-Order_Date"
  }, _react.default.createElement("span", null, "Order Date:"), _react.default.createElement("span", null, createdAt)), _react.default.createElement("div", null, items), _react.default.createElement(_TotalAmount.default, {
    productsVM,
    orderVM
  })));
}
...
(function () {
  ...
  reactHotLoader.register(Order, "Order", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/orderList/molecules/Order.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/presentation/views/modules/orderList/molecules/OrderItem.js":
/*!************************************************************************************!*\
  !*** ./client/scripts/presentation/views/modules/orderList/molecules/OrderItem.js ***!
  \************************************************************************************/
/*! no static exports found */
...
(function () {
  ...
  reactHotLoader.register(OrderItem, "OrderItem", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/orderList/molecules/OrderItem.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/presentation/views/modules/orderList/molecules/TotalAmount.js":
/*!**************************************************************************************!*\
  !*** ./client/scripts/presentation/views/modules/orderList/molecules/TotalAmount.js ***!
  \**************************************************************************************/
/*! no static exports found */
...
(function () {
  ...
  reactHotLoader.register(TotalPrice, "TotalPrice", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/orderList/molecules/TotalAmount.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/presentation/views/modules/orderList/organisms/OrderList.js":
/*!************************************************************************************!*\
  !*** ./client/scripts/presentation/views/modules/orderList/organisms/OrderList.js ***!
  \************************************************************************************/
/*! no static exports found */
...
var _connector = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/presentation/views/modules/orderList/hocs/connector */ "./client/scripts/presentation/views/modules/orderList/hocs/connector.js"));
...
var _Order = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/presentation/views/modules/orderList/molecules/Order */ "./client/scripts/presentation/views/modules/orderList/molecules/Order.js"));
...
const enhancer = (0, _recompose.compose)(_connector.default, (0, _recompose.lifecycle)({
  componentWillUpdate() {
...
const _default = enhancer(({
  ...
  const exist = customerVM.exist();
  const orders = orderListVM.getOrderList().map(orderVM => {
    ...
    return _react.default.createElement(_Order.default, _extends({
      key: id
    }, _props));
  });
  return _react.default.createElement(_react.Fragment, null, isFetching ? _react.default.createElement(_Loading.default, null) : _react.default.createElement("div", {
    className: "ordrlst-Container"
  }, exist ? _react.default.createElement(_react.Fragment, null, orders.size > 0 ? _react.default.createElement(_react.Fragment, null, _react.default.createElement("span", null, exist), _react.default.createElement("div", {
    className: "ordrlst-Orders"
  }, orders)) : _react.default.createElement("div", {
    className: "ordrlst-Section"
  }, _react.default.createElement("span", null, "Order is empty..."))) : _react.default.createElement("div", {
    className: "ordrlst-Section"
  }, _react.default.createElement("span", null, "Not Found Customer. Please Login."))));
});
...
(function () {
  ...
  reactHotLoader.register(enhancer, "enhancer", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/orderList/organisms/OrderList.js");
  reactHotLoader.register(_default, "default", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/orderList/organisms/OrderList.js");
  leaveModule(module);
})();
...
/******/ });
//# sourceMappingURL=pageOrderList.bundle.js.map