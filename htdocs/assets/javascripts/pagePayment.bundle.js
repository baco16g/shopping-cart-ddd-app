...
/******/ 	deferredModules.push(["./client/scripts/entrypoints/pagePayment.js","vendor"]);
...
/***/ "./client/scripts/adapter/processAdapter/services/checkout.js":
/*!********************************************************************!*\
  !*** ./client/scripts/adapter/processAdapter/services/checkout.js ***!
  \********************************************************************/
/*! no static exports found */
...
var _cart = __webpack_require__(/*! ./client/scripts/port/redux/packages/cart */ "./client/scripts/port/redux/packages/cart.js");
...
function* resetCartItems() {
  yield (0, _effects.call)(_storage.deleteLocalStorageByKey, 'cart');
  yield (0, _effects.put)(_cart.creators.resetCartItems({}));
}

function* reduceStock(eventKey) {
  yield (0, _effects.put)(_common.creators.pushFetchingQueue({
    eventkey: eventKey
  }));
  const cartVM = yield (0, _effects.select)(state => state.cartVM);
  const reqData = cartVM.toJS();
  const {
    payload,
    err
  } = yield (0, _effects.call)(_API_FUNC.default.PATCH.PRODUCT_STOCK, (0, _humps.decamelizeKeys)(reqData));
  yield (0, _effects.put)(_common.creators.deleteFetchingQueue({
    eventkey: eventKey
  }));
  if (!payload && err) throw new Error('システムエラーが発生しました。');
...
function* saveOrder(eventKey) {
  yield (0, _effects.put)(_common.creators.pushFetchingQueue({
    eventkey: eventKey
  }));
  const cartVM = yield (0, _effects.select)(state => state.cartVM);
  const customerVM = yield (0, _effects.select)(state => state.customerVM);
  const reqData = {
  ...
  const {
    payload,
    err
  } = yield (0, _effects.call)(_API_FUNC.default.POST.ORDER, (0, _humps.decamelizeKeys)(reqData));
  yield (0, _effects.put)(_common.creators.deleteFetchingQueue({
    eventkey: eventKey
  }));
  if (!payload && err) throw new Error('システムエラーが発生しました。');
...
function* subscribeToRequestCheckout() {
  while (true) {
    yield (0, _effects.take)(_cart.types.requestCheckout);
    yield (0, _effects.call)(reduceStock, 'requestCheckout');
    yield (0, _effects.fork)(resetCartItems);
    yield (0, _effects.fork)(saveOrder);
    yield (0, _effects.call)(_storage.wait, 500);
    location.href = '/order/';
  }
}

const _default = function* () {
  yield (0, _effects.fork)(subscribeToRequestCheckout);
};
...
(function () {
  ...
  reactHotLoader.register(resetCartItems, "resetCartItems", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/adapter/processAdapter/services/checkout.js");
  reactHotLoader.register(reduceStock, "reduceStock", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/adapter/processAdapter/services/checkout.js");
  reactHotLoader.register(saveOrder, "saveOrder", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/adapter/processAdapter/services/checkout.js");
  reactHotLoader.register(subscribeToRequestCheckout, "subscribeToRequestCheckout", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/adapter/processAdapter/services/checkout.js");
  reactHotLoader.register(_default, "default", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/adapter/processAdapter/services/checkout.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/adapter/processAdapter/services/manipulateCart.js":
/*!**************************************************************************!*\
  !*** ./client/scripts/adapter/processAdapter/services/manipulateCart.js ***!
  \**************************************************************************/
/*! no static exports found */
...
function* restoreCartItems() {
  yield (0, _effects.put)(_common.creators.pushFetchingQueue({
    eventkey: 'restoreCartItems'
  }));
  const src = yield (0, _effects.call)(_storage.loadLocalStorageByKey, 'cart');
  yield (0, _effects.put)(_cart.creators.restoreCartItems(src));
  yield (0, _effects.put)(_common.creators.deleteFetchingQueue({
    eventkey: 'restoreCartItems'
  }));
}
...
function* saveCartItems() {
  const cartVM = yield (0, _effects.select)(state => state.cartVM);
  const src = cartVM.getCartItemsJS();
  (0, _storage.saveLocalStorageByKey)(src, 'cart');
}
...
function* subscribeToSaveCartItems() {
  while (true) {
    yield (0, _effects.take)(_cart.types.saveCartItems);
    yield (0, _effects.call)(_storage.wait, 100);
    yield (0, _effects.fork)(saveCartItems);
  }
}

function* subscribeToRestoreFailed() {
  while (true) {
    yield (0, _effects.take)(_cart.types.restoreFailed);
    yield (0, _effects.call)(_storage.wait, 1000);
    yield (0, _effects.fork)(resetCartItems);
...
function* subscribeToAddItemToCart() {
  while (true) {
    yield (0, _effects.take)(_cart.types.addItemToCart);
    yield (0, _effects.call)(_storage.wait, 100);
    yield (0, _effects.fork)(saveCartItems);
...
function* subscribeToGoingToPayment() {
  while (true) {
    yield (0, _effects.take)(_cart.types.goToPayment);
    yield (0, _effects.call)(_storage.wait, 100);
    yield (0, _effects.fork)(saveCartItems);
    const customerVM = yield (0, _effects.select)(state => state.customerVM);
...
const _default = function* () {
  yield (0, _effects.fork)(restoreCartItems);
  yield (0, _effects.fork)(subscribeToSaveCartItems);
  yield (0, _effects.fork)(subscribeToRestoreFailed);
  yield (0, _effects.fork)(subscribeToAddItemToCart);
  yield (0, _effects.fork)(subscribeToGoingToPayment);
};
...
(function () {
  ...
  reactHotLoader.register(restoreCartItems, "restoreCartItems", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/adapter/processAdapter/services/manipulateCart.js");
  reactHotLoader.register(saveCartItems, "saveCartItems", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/adapter/processAdapter/services/manipulateCart.js");
  reactHotLoader.register(resetCartItems, "resetCartItems", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/adapter/processAdapter/services/manipulateCart.js");
  reactHotLoader.register(subscribeToSaveCartItems, "subscribeToSaveCartItems", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/adapter/processAdapter/services/manipulateCart.js");
  reactHotLoader.register(subscribeToRestoreFailed, "subscribeToRestoreFailed", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/adapter/processAdapter/services/manipulateCart.js");
  reactHotLoader.register(subscribeToAddItemToCart, "subscribeToAddItemToCart", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/adapter/processAdapter/services/manipulateCart.js");
  reactHotLoader.register(subscribeToGoingToPayment, "subscribeToGoingToPayment", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/adapter/processAdapter/services/manipulateCart.js");
  reactHotLoader.register(_default, "default", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/adapter/processAdapter/services/manipulateCart.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/domain/Cart/Cart.js":
/*!********************************************!*\
  !*** ./client/scripts/domain/Cart/Cart.js ***!
  \********************************************/
/*! no static exports found */
...
var _CartItem = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/domain/Cart/CartItem */ "./client/scripts/domain/Cart/CartItem.js"));
...
const props = def => {
  return _extends({
    cartItems: (0, _immutable.List)([])
  }, def);
};

const CartModel = def => class extends (0, _Entity.default)(props(def)) {
  constructor() {
    super();
  }
  /**********************
  ...
  selectCartItemByProductCode(productCode) {
  ...
  resetCartItems() {
    return this.set('cartItems', (0, _immutable.List)([]));
  }

  restoreCartItems(src) {
    if (src === null) return this;
    const deserializedList = (0, _immutable.fromJS)(src).map(m => {
      return new ((0, _CartItem.default)({}))({
        productCode: m.get('productCode'),
        quantity: m.get('quantity')
      }).restoreID(m.get('id')).restoreCreatedAt(new Date(m.get('createdAt'))).restoreUpdatedAt(new Date(m.get('updatedAt')));
    });
  ...
  pushCartItem({
    ...
    return this.update('cartItems', items => items.push(new ((0, _CartItem.default)({}))({
      productCode,
      quantity
    })));
  }
  ...
  removeCartItem(id) {
    const index = this._getCartItemIndexByID(id);
  ...
  increaseQuantityOfCartItem(productCode) {
    return this.update('cartItems', list => {
      const _targetIdx = this._getCartItemIndexByProductCode(productCode);
  ...
  decreaseQuantityOfCartItem(productCode) {
    return this.update('cartItems', list => {
      const _targetIdx = this._getCartItemIndexByProductCode(productCode);
  ...
  _getCartItemIndexByID(id) {
    return this.getCartItems().findIndex(item => item.getID() === id);
  }

  _getCartItemIndexByProductCode(productCode) {
    return this.getCartItems().findIndex(item => item.getProductCode() === productCode);
  }
...
(function () {
  ...
  reactHotLoader.register(props, "props", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/domain/Cart/Cart.js");
  reactHotLoader.register(CartModel, "CartModel", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/domain/Cart/Cart.js");
  reactHotLoader.register(_default, "default", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/domain/Cart/Cart.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/domain/Cart/CartItem.js":
/*!************************************************!*\
  !*** ./client/scripts/domain/Cart/CartItem.js ***!
  \************************************************/
/*! no static exports found */
...
const CartItemModel = def => class extends (0, _Entity.default)(props(def)) {
  constructor(args) {
    super(args);
    return this.withMutations(m => m.set('productCode', args.productCode).set('quantity', +args.quantity));
  }
  /**********************
   * Getter
   **********************/
...
(function () {
  ...
  reactHotLoader.register(props, "props", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/domain/Cart/CartItem.js");
  reactHotLoader.register(CartItemModel, "CartItemModel", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/domain/Cart/CartItem.js");
  reactHotLoader.register(_default, "default", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/domain/Cart/CartItem.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/domain/Cart/CartView.js":
/*!************************************************!*\
  !*** ./client/scripts/domain/Cart/CartView.js ***!
  \************************************************/
/*! no static exports found */
...
var _Cart = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/domain/Cart/Cart */ "./client/scripts/domain/Cart/Cart.js"));
...
class CartViewModel extends (0, _Cart.default)({}) {
  constructor() {
    super();
  }
  /**********************
...
(function () {
  ...
  reactHotLoader.register(CartViewModel, "CartViewModel", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/domain/Cart/CartView.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/entrypoints/pagePayment.js":
/*!***************************************************!*\
  !*** ./client/scripts/entrypoints/pagePayment.js ***!
  \***************************************************/
/*! no static exports found */
...
var _payment = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/presentation/views/modules/payment */ "./client/scripts/presentation/views/modules/payment/index.js"));
...
var _CartView = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/domain/Cart/CartView */ "./client/scripts/domain/Cart/CartView.js"));
...
var _manipulateCart = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/adapter/processAdapter/services/manipulateCart */ "./client/scripts/adapter/processAdapter/services/manipulateCart.js"));

var _checkout = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/adapter/processAdapter/services/checkout */ "./client/scripts/adapter/processAdapter/services/checkout.js"));
...
const rootReducer = (0, _extendReducers.default)({
  ...
  productsVM: (0, _products.reducer)(new _ProductsView.default()),
  cartVM: (0, _cart.reducer)(new _CartView.default())
});
...
const MainViewAdaptedStore = () => {
  return _react.default.createElement(_viewAdapter.default, {
    store: store
  }, _react.default.createElement(_payment.default, null));
};

(0, _renderViews.default)('data-react-header-app', HeaderViewAdaptedStore);
(0, _renderViews.default)('data-react-payment-app', MainViewAdaptedStore);
(0, _runRootSaga.default)(_processAdapter.sagaMiddleware)([_commonService.default, _auth.default, _setProducts.default, _manipulateCart.default, _checkout.default]);
;
...
(function () {
  ...
  reactHotLoader.register(rootReducer, "rootReducer", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/entrypoints/pagePayment.js");
  reactHotLoader.register(store, "store", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/entrypoints/pagePayment.js");
  reactHotLoader.register(HeaderViewAdaptedStore, "HeaderViewAdaptedStore", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/entrypoints/pagePayment.js");
  reactHotLoader.register(MainViewAdaptedStore, "MainViewAdaptedStore", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/entrypoints/pagePayment.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/port/redux/packages/cart.js":
/*!****************************************************!*\
  !*** ./client/scripts/port/redux/packages/cart.js ***!
  \****************************************************/
/*! no static exports found */
...
const {
  ...
  creators,
  reducer
} = (0, _createActionReducer.default)(['addItemToCart', 'restoreCartItems', 'pushCartItem', 'removeCartItem', 'increaseQuantityOfCartItem', 'updateQuantityOfCartItem', 'goToPayment', 'requestCheckout', 'restoreFailed', 'saveCartItems', 'resetCartItems'], '/cart/');
exports.reducer = reducer;
exports.creators = creators;
exports.types = types;
;
...
(function () {
  ...
  reactHotLoader.register(types, "types", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/port/redux/packages/cart.js");
  reactHotLoader.register(creators, "creators", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/port/redux/packages/cart.js");
  reactHotLoader.register(reducer, "reducer", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/port/redux/packages/cart.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/presentation/views/modules/payment/hocs/connector.js":
/*!*****************************************************************************!*\
  !*** ./client/scripts/presentation/views/modules/payment/hocs/connector.js ***!
  \*****************************************************************************/
/*! no static exports found */
...
const creators = _extends({}, _products.creators, _cart.creators, _cart.creators);
...
(function () {
  ...
  reactHotLoader.register(creators, "creators", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/payment/hocs/connector.js");
  reactHotLoader.register(connector, "connector", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/payment/hocs/connector.js");
  reactHotLoader.register(_default, "default", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/payment/hocs/connector.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/presentation/views/modules/payment/hocs/withHandlers/checkout.js":
/*!*****************************************************************************************!*\
  !*** ./client/scripts/presentation/views/modules/payment/hocs/withHandlers/checkout.js ***!
  \*****************************************************************************************/
/*! no static exports found */
...
const _default = ({
  ...
  actions.requestCheckout(); // product
};
...
(function () {
  ...
  reactHotLoader.register(_default, "default", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/payment/hocs/withHandlers/checkout.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/presentation/views/modules/payment/index.js":
/*!********************************************************************!*\
  !*** ./client/scripts/presentation/views/modules/payment/index.js ***!
  \********************************************************************/
/*! no static exports found */
...
var _Confirm = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/presentation/views/modules/payment/organisms/Confirm */ "./client/scripts/presentation/views/modules/payment/organisms/Confirm.js"));
...
function App() {
  return _react.default.createElement(_react.Fragment, null, _react.default.createElement(_Confirm.default, null));
}
...
(function () {
  ...
  reactHotLoader.register(App, "App", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/payment/index.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/presentation/views/modules/payment/molecules/CartItem.js":
/*!*********************************************************************************!*\
  !*** ./client/scripts/presentation/views/modules/payment/molecules/CartItem.js ***!
  \*********************************************************************************/
/*! no static exports found */
...
function CartItem({
  ...
  return _react.default.createElement("div", {
    className: "pymnt-Cart_Item"
  }, _react.default.createElement(_react.Fragment, null, _react.default.createElement("div", {
    className: "pymnt-Cart_Item_thumb"
  }, _react.default.createElement("img", {
    src: thumbnailUrl,
    alt: name
  })), _react.default.createElement("h3", {
    className: "pymnt-Cart_Item_name"
  }, name), _react.default.createElement("h4", {
    className: "pymnt-Cart_Item_price"
  }, formattedPrice), _react.default.createElement("div", {
    className: "pymnt-Cart_Item_stock"
  }, cartItemQuantity)));
}
...
(function () {
  ...
  reactHotLoader.register(CartItem, "CartItem", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/payment/molecules/CartItem.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/presentation/views/modules/payment/molecules/Checkout.js":
/*!*********************************************************************************!*\
  !*** ./client/scripts/presentation/views/modules/payment/molecules/Checkout.js ***!
  \*********************************************************************************/
/*! no static exports found */
...
var _checkout = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/presentation/views/modules/payment/hocs/withHandlers/checkout */ "./client/scripts/presentation/views/modules/payment/hocs/withHandlers/checkout.js"));
...
const enhancer = (0, _recompose.compose)((0, _recompose.withHandlers)({
...
const _default = enhancer(({
  ...
  return _react.default.createElement("div", {
    className: "pymnt-Checkout"
  }, _react.default.createElement("button", {
    className: "pymnt-Checkout_Button",
    onClick: checkout
  }, "Checkout"));
});
...
(function () {
  ...
  reactHotLoader.register(enhancer, "enhancer", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/payment/molecules/Checkout.js");
  reactHotLoader.register(_default, "default", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/payment/molecules/Checkout.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/presentation/views/modules/payment/molecules/PaymentInfo.js":
/*!************************************************************************************!*\
  !*** ./client/scripts/presentation/views/modules/payment/molecules/PaymentInfo.js ***!
  \************************************************************************************/
/*! no static exports found */
...
function PaymentInfo({
  ...
  return _react.default.createElement("ul", {
    className: "pymnt-Card"
  }, _react.default.createElement("li", {
    className: "pymnt-Card_Item"
  }, _react.default.createElement("h4", {
    className: "pymnt-Card_Item_hdg"
  }, "Contract Name"), _react.default.createElement("p", {
    className: "pymnt-Card_Item_txt"
  }, contractName)), _react.default.createElement("li", {
    className: "pymnt-Card_Item"
  }, _react.default.createElement("h4", {
    className: "pymnt-Card_Item_hdg"
  }, "Card Number"), _react.default.createElement("p", {
    className: "pymnt-Card_Item_txt"
  }, cardNumber)), _react.default.createElement("li", {
    className: "pymnt-Card_Item"
  }, _react.default.createElement("h4", {
    className: "pymnt-Card_Item_hdg"
  }, "Expiry"), _react.default.createElement("p", {
    className: "pymnt-Card_Item_txt"
  }, expiry)));
}
...
(function () {
  ...
  reactHotLoader.register(PaymentInfo, "PaymentInfo", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/payment/molecules/PaymentInfo.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/presentation/views/modules/payment/molecules/TotalAmount.js":
/*!************************************************************************************!*\
  !*** ./client/scripts/presentation/views/modules/payment/molecules/TotalAmount.js ***!
  \************************************************************************************/
/*! no static exports found */
...
function TotalPrice({
  ...
  const items = cartVM.getCartItemsJS();
  const totalAmount = productsVM.formatedTotalAmount(items);
  return _react.default.createElement(_react.Fragment, null, _react.default.createElement("h4", {
    className: "pymnt-CartItems_TotalAmount",
...
(function () {
  ...
  reactHotLoader.register(TotalPrice, "TotalPrice", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/payment/molecules/TotalAmount.js");
  leaveModule(module);
})();
...
/***/ "./client/scripts/presentation/views/modules/payment/organisms/Confirm.js":
/*!********************************************************************************!*\
  !*** ./client/scripts/presentation/views/modules/payment/organisms/Confirm.js ***!
  \********************************************************************************/
/*! no static exports found */
...
var _connector = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/presentation/views/modules/payment/hocs/connector */ "./client/scripts/presentation/views/modules/payment/hocs/connector.js"));
...
var _CartItem = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/presentation/views/modules/payment/molecules/CartItem */ "./client/scripts/presentation/views/modules/payment/molecules/CartItem.js"));

var _TotalAmount = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/presentation/views/modules/payment/molecules/TotalAmount */ "./client/scripts/presentation/views/modules/payment/molecules/TotalAmount.js"));

var _PaymentInfo = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/presentation/views/modules/payment/molecules/PaymentInfo */ "./client/scripts/presentation/views/modules/payment/molecules/PaymentInfo.js"));

var _Checkout = _interopRequireDefault(__webpack_require__(/*! ./client/scripts/presentation/views/modules/payment/molecules/Checkout */ "./client/scripts/presentation/views/modules/payment/molecules/Checkout.js"));
...
const _default = enhancer(({
  ...
  const exist = customerVM.exist();
  const cartItems = cartVM.getCartItems().map(cartItemVM => {
    ...
    return _react.default.createElement(_CartItem.default, _extends({
      key: id
    }, _props));
  });
  return _react.default.createElement(_react.Fragment, null, isFetching ? _react.default.createElement(_Loading.default, null) : _react.default.createElement("div", {
    className: "pymnt-Container"
  }, exist ? _react.default.createElement(_react.Fragment, null, cartItems.size > 0 ? _react.default.createElement(_react.Fragment, null, _react.default.createElement("section", {
    className: "pymnt-Section"
  }, _react.default.createElement("h3", {
    className: "pymnt-Section_Hdg"
  }, "Cart Items"), _react.default.createElement("div", {
    className: "pymnt-CartItems"
  }, cartItems), _react.default.createElement(_TotalAmount.default, {
    productsVM,
    cartVM
    ...
    className: "pymnt-Section_Hdg"
  }, "Payment Info"), _react.default.createElement(_PaymentInfo.default, {
    customerVM
  })), _react.default.createElement("section", {
    className: "pymnt-Section"
    ...
    className: "pymnt-Section"
  }, _react.default.createElement("span", null, "Cart is empty..."))) : _react.default.createElement("p", null, "Not Found Customer")));
});
...
(function () {
  ...
  reactHotLoader.register(enhancer, "enhancer", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/payment/organisms/Confirm.js");
  reactHotLoader.register(_default, "default", "/Users/yuk-kobayashi/dev/git.baco16g/spa-base/client/scripts/presentation/views/modules/payment/organisms/Confirm.js");
  leaveModule(module);
})();
...
/******/ });
//# sourceMappingURL=pagePayment.bundle.js.map